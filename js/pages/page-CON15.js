  ...
  hotspots: [
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: 'CON15', hotspot: 'agent-sink', label: 'MTConnect Agent sink' },
          { page: 'CON15', hotspot: 'emit-mtconnect', label: 'emit_mtconnect() Lua function' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON06', label: 'CON06 \u2014 Source connectors' },
          { page: 'CON15', hotspot: 'agent-sink', label: 'MTConnect Agent sink' },
          { page: 'CON12', label: 'CON12 \u2014 PLC walkthrough' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON15', hotspot: 'emit-mtconnect', label: 'emit_mtconnect() mapping' },
