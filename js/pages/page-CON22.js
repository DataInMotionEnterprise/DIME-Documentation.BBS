...
DIME_PAGES['CON22'] = {
  id: 'CON22',
  title: 'CON22 \u2014 Instance Chaining',
  file: 'content/CON22-instance-chaining.md',
  hotspots: [
    {
      id: 'chaining',
      startLine: 40, startCol: 3, endLine: 71, endCol: 90,
      ...
      panel: {
        ...
        body:
          ...
          '</ul>',
        related: [
          { page: 'CON28', label: 'CON28 \u2014 Edge-to-Cloud patterns' },
          { page: 'CON05', hotspot: 'big-picture', label: 'CON05 \u2014 Three-layer architecture' },
    ...
    {
      id: 'three-tier',
      startLine: 77, startCol: 4, endLine: 96, endCol: 82,
      ...
      panel: {
        ...
        related: [
          { page: 'CON22', hotspot: 'chaining', label: 'Instance chaining concept' },
          { page: 'CON25', label: 'CON25 \u2014 DIME Horizon' }
        ]
      }
    },
    {
      id: 'edge-config',
      startLine: 104, startCol: 3, endLine: 126, endCol: 90,
      ...
      panel: {
        ...
        related: [
          { page: 'CON22', hotspot: 'aggregator', label: 'Aggregator instance config' },
          { page: 'CON06', hotspot: 'industrial', label: 'CON06 \u2014 Industrial PLC connectors' }
        ]
      }
    },
    {
      id: 'aggregator',
      startLine: 134, startCol: 3, endLine: 157, endCol: 90,
      ...
      panel: {
        ...
        related: [
          { page: 'CON22', hotspot: 'edge-config', label: 'Edge instance config' },
          { page: 'CON22', hotspot: 'hot-reconfig', label: 'Add sinks at runtime' }
        ]
      }
    },
    {
      id: 'hot-reconfig',
      startLine: 165, startCol: 3, endLine: 182, endCol: 90,
