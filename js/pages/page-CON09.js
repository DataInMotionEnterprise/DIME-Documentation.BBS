  ...
  hotspots: [
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON05', hotspot: 'lifecycle', label: 'CON05 \u2014 Connector lifecycle stages' },
          { page: 'CON09', hotspot: 'result-var', label: 'CON09 \u2014 The result variable' },
          { page: 'CON09', hotspot: 'emit', label: 'CON09 \u2014 emit() function' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON09', hotspot: 'lifecycle', label: 'CON09 \u2014 When scripts run' },
          { page: 'CON09', hotspot: 'emit', label: 'CON09 \u2014 emit() for multi-output' },
          { page: 'CON05', hotspot: 'message-format', label: 'CON05 \u2014 MessageBoxMessage format' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON09', hotspot: 'helpers', label: 'CON09 \u2014 Lua vs Python helper reference' },
          { page: 'CON09', hotspot: 'transforms', label: 'CON09 \u2014 Basic transform examples' },
    ...
    },
    {
      ...
      panel: {
        ...
        body:
          ...
          '</ul>',
        related: [
          { page: 'CON09', hotspot: 'lang-select', label: 'CON09 \u2014 Choosing Lua vs Python' },
          { page: 'CON09', hotspot: 'helpers', label: 'CON09 \u2014 Helper function reference' },
          { page: 'CON09', hotspot: 'examples', label: 'CON09 \u2014 Full practical examples' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        yaml:
          ...
          '  return None',
        related: [
          { page: 'CON09', hotspot: 'helpers', label: 'CON09 \u2014 Built-in helper functions' },
          { page: 'CON09', hotspot: 'result-var', label: 'CON09 \u2014 The result variable' },
          { page: 'CON08', hotspot: 'paths', label: 'CON08 \u2014 Message path format' },
          { page: 'CON12', hotspot: 'complete-flow', label: 'CON12 \u2014 PLC to dashboard walkthrough' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON10', hotspot: 'cache-read', label: 'CON10 \u2014 Cache API deep dive' },
          { page: 'CON09', hotspot: 'emit', label: 'CON09 \u2014 emit() function' },
          { page: 'CON09', hotspot: 'examples', label: 'CON09 \u2014 Practical examples' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON09', hotspot: 'emit', label: 'CON09 \u2014 emit() function' },
          { page: 'CON09', hotspot: 'helpers', label: 'CON09 \u2014 Helper functions' },
          { page: 'CON10', hotspot: 'cache-read', label: 'CON10 \u2014 Cache API details' },
