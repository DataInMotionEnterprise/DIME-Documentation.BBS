...
DIME_PAGES['CON02'] = {
  id: 'CON02',
  title: 'CON02 \u2014 The DIME Ecosystem',
  ...
  hotspots: [
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON02', hotspot: 'horizon-tier', label: 'CON02 \u2014 Horizon: the site gateway' },
          { page: 'CON02', hotspot: 'scale', label: 'CON02 \u2014 Enterprise scale capabilities' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON02', hotspot: 'zenith-tier', label: 'CON02 \u2014 Zenith: cloud command center' },
          { page: 'CON02', hotspot: 'connector-tier', label: 'CON02 \u2014 Connector: edge data collection' },
          { page: 'CON02', hotspot: 'communication', label: 'CON02 \u2014 Pull-based communication model' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON01', hotspot: 'connectors', label: 'CON01 \u2014 47+ connector types' },
          { page: 'CON05', hotspot: 'big-picture', label: 'CON05 \u2014 Architecture deep dive' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON02', hotspot: 'horizon-tier', label: 'CON02 \u2014 Horizon: pull-based architecture' },
          { page: 'CON02', hotspot: 'scale', label: 'CON02 \u2014 Enterprise scale capabilities' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON02', hotspot: 'zenith-tier', label: 'CON02 \u2014 Zenith: fleet command center' },
          { page: 'CON02', hotspot: 'communication', label: 'CON02 \u2014 Pull-based communication' },
          { page: 'CON01', hotspot: 'features', label: 'CON01 \u2014 Why choose DIME?' }
        ]
      }
    }
  ]
