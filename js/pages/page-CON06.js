  ...
  hotspots: [
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON07', label: 'CON07 \u2014 MQTT as a sink' },
          { page: 'CON05', label: 'CON05 \u2014 Architecture overview' },
          { page: 'CON04', label: 'CON04 \u2014 YAML configuration basics' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON07', label: 'CON07 \u2014 Database sink connectors' },
          { page: 'CON05', label: 'CON05 \u2014 Architecture overview' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON07', label: 'CON07 \u2014 HTTP/WebSocket server sinks' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON05', label: 'CON05 \u2014 Architecture: source types detail' },
