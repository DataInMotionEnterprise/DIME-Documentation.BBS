...
DIME_PAGES['CON21'] = {
  id: 'CON21',
  title: 'CON21 \u2014 Multi-File Configs',
  ...
  hotspots: [
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON21', hotspot: 'load-order', label: 'CON21 \u2014 How files merge' },
          { page: 'CON04', hotspot: 'yaml-basics', label: 'CON04 \u2014 YAML basics' },
          { page: 'CON03', hotspot: 'config-dir', label: 'CON03 \u2014 Config directory' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON21', hotspot: 'single-vs-multi', label: 'CON21 \u2014 When to use multi-file' },
          { page: 'CON21', hotspot: 'file-patterns', label: 'CON21 \u2014 Organization patterns' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON04', hotspot: 'yaml-basics', label: 'CON04 \u2014 YAML syntax' },
          { page: 'CON21', hotspot: 'load-order', label: 'CON21 \u2014 File loading order' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON21', hotspot: 'single-vs-multi', label: 'CON21 \u2014 When to split files' },
          { page: 'CON21', hotspot: 'load-order', label: 'CON21 \u2014 How files merge' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON21', hotspot: 'file-patterns', label: 'CON21 \u2014 File organization' },
          { page: 'CON03', hotspot: 'config-dir', label: 'CON03 \u2014 Configuration directory' }
        ]
      }
    }
  ]
