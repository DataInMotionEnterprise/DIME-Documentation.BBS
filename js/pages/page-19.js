...
DIME_PAGES['19'] = {
  id: '19',
  title: '19 \u2014 Connector UX',
  file: 'content/19-connector-ux.md',
  hotspots: [
    {
      id: 'multi-instance',
      ...
      panel: {
        ...
        related: [
          ...
          { page: '19', hotspot: 'live-dashboard', label: '19 \u2014 Live Dashboard' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: '18', hotspot: 'metrics', label: '18 \u2014 Performance metrics' },
          { page: '17', label: '17 \u2014 WebSocket' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: '16', label: '16 \u2014 REST API (config endpoints)' },
