...
DIME_PAGES['25'] = {
  id: '25',
  title: '25 \u2014 Horizon Gateway',
  file: 'content/25-horizon-gateway.md',
  hotspots: [
    {
      id: 'pull-based',
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: '26', label: '26 \u2014 Zenith Cloud' },
          { page: '25', hotspot: 'tasks', label: 'Supported task types' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: '26', label: '26 \u2014 Zenith Cloud' },
          { page: '25', hotspot: 'checkin', label: 'Check-in cycle' },
          { page: '16', label: '16 \u2014 Admin REST API' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: '23', label: '23 \u2014 Service Deployment' },
