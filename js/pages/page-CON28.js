  ...
  hotspots: [
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON02', hotspot: 'connector-tier', label: 'CON02 \u2014 Connector overview' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON02', hotspot: 'horizon-tier', label: 'CON02 \u2014 Horizon overview' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON02', hotspot: 'zenith-tier', label: 'CON02 \u2014 Zenith overview' },
          { page: 'CON02', hotspot: 'scale', label: 'CON02 \u2014 Enterprise scale' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON05', hotspot: 'data-flow', label: 'CON05 \u2014 Detailed data flow' },
          { page: 'CON22', label: 'CON22 \u2014 Instance chaining patterns' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: 'CON16', label: 'CON16 \u2014 Admin API for runtime changes' }
        ]
      }
    }
  ]
