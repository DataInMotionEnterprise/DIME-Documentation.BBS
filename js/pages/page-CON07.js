  ...
  hotspots: [
    {
      ...
      panel: {
        ...
        yaml:
          ...
          '    include_filter: plc/.*',
        related: [
          { page: 'CON06', label: 'CON06 \u2014 Source connectors catalog' },
    ...
    },
    {
      ...
      panel: {
        ...
        yaml:
          ...
          '    include_filter: plc/.*',
        related: [
          { page: 'CON06', label: 'CON06 \u2014 Database source connectors' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON06', label: 'CON06 \u2014 MQTT source connector' },
          { page: 'CON08', label: 'CON08 \u2014 Filtering & routing' },
          { page: 'CON05', label: 'CON05 \u2014 Architecture overview' }
        ]
      }
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: 'CON05', label: 'CON05 \u2014 Architecture: data flow' }
        ]
      }
    }
  ]
