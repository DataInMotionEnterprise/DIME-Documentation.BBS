  ...
  hotspots: [
    {
      ...
      panel: {
        ...
        related: [
          { page: '27', hotspot: 'live-dashboard', label: 'Live dashboard metrics' },
          { page: '27', hotspot: 'deep-dive', label: 'Deep-dive detail view' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: '27', hotspot: 'fleet-tree', label: 'Fleet tree navigation' },
          { page: '26', hotspot: 'stale-detection', label: '26 \u2014 Stale detection' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: '27', hotspot: 'remote-config', label: 'Remote YAML editing' },
          { page: '19', label: '19 \u2014 Connector UX' },
          { page: '18', label: '18 \u2014 Health & Faults' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: '26', label: '26 \u2014 Zenith Cloud' },
          { page: '25', hotspot: 'tasks', label: '25 \u2014 Supported tasks' },
          { page: '16', label: '16 \u2014 Admin REST API' },
          { page: '28', label: '28 \u2014 Edge to Cloud' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: '25', hotspot: 'tasks', label: '25 \u2014 Supported tasks' },
          { page: '25', hotspot: 'checkin', label: '25 \u2014 Check-in cycle' },
          { page: '26', hotspot: 'stale-detection', label: '26 \u2014 Stale detection' }
        ]
      }
    }
