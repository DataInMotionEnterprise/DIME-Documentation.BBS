  ...
  hotspots: [
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON05', label: 'CON05 \u2014 Architecture: how DIME eliminates this' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON05', label: 'CON05 \u2014 Architecture deep dive' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON05', hotspot: 'data-flow', label: 'CON05 \u2014 Detailed data flow diagram' },
          { page: 'CON05', hotspot: 'source-types', label: 'CON05 \u2014 Source connector types' }
        ]
      }
    },
    {
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON03', label: 'CON03 \u2014 Installation: get DIME running' },
          { page: 'CON05', hotspot: 'message-format', label: 'CON05 \u2014 The MessageBoxMessage format' }
        ]
      }
    }
  ]
