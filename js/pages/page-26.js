...
DIME_PAGES['26'] = {
  id: '26',
  title: '26 \u2014 Zenith Cloud',
  file: 'content/26-zenith-cloud.md',
  hotspots: [
    {
      id: 'architecture',
      ...
      panel: {
        ...
        related: [
          ...
          { page: '27', label: '27 \u2014 Zenith UX' },
          { page: '02', label: '02 \u2014 The DIME Ecosystem' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        body:
          ...
          '</ul>',
        related: [
          { page: '26', hotspot: 'api', label: 'API endpoints' },
          { page: '26', hotspot: 'stale-detection', label: 'Stale detection' },
          { page: '27', label: '27 \u2014 Zenith UX' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: '26', hotspot: 'auth', label: 'Key-based authentication' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: '26', hotspot: 'collections', label: 'MongoDB collections' },
          { page: '25', hotspot: 'checkin', label: '25 \u2014 Check-in cycle' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: '25', hotspot: 'config', label: '25 \u2014 Horizon configuration' },
          { page: '26', hotspot: 'api', label: 'API endpoints' },
          { page: '02', label: '02 \u2014 The DIME Ecosystem' }
        ]
      }
