  ...
  hotspots: [
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: 'CON01', hotspot: 'how-it-works', label: 'CON01 \u2014 How it works overview' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON05', hotspot: 'message-format', label: 'The MessageBoxMessage format' },
          { page: 'CON05', hotspot: 'source-types', label: 'Source connector base classes' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON05', hotspot: 'data-flow', label: 'Detailed data flow diagram' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON05', hotspot: 'source-types', label: 'Source connector base classes' },
          { page: 'CON05', hotspot: 'system-diagram', label: 'Full system diagram' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        body:
          ...
          '</ul>',
        related: [
          { page: 'CON06', label: 'CON06 \u2014 Source Connector Catalog' },
          { page: 'CON01', hotspot: 'connectors', label: 'CON01 \u2014 30+ connector types' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON03', hotspot: 'verify', label: 'CON03 \u2014 Verify it works' },
          { page: 'CON03', hotspot: 'ports', label: 'CON03 \u2014 Default ports' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON05', hotspot: 'lifecycle', label: 'Connector lifecycle stages' },
          { page: 'CON05', hotspot: 'admin-server', label: 'Admin server endpoints' }
        ]
      }
    },
    {
