...
DIME_PAGES['CON17'] = {
  id: 'CON17',
  title: 'CON17 \u2014 WebSocket Monitoring',
  ...
  hotspots: [
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON16', hotspot: 'status-endpoint', label: 'CON16 \u2014 REST API /status endpoint' },
          { page: 'CON17', hotspot: 'ws-sink', label: 'CON17 \u2014 WebSocket Server sink' },
          { page: 'CON18', hotspot: 'states', label: 'CON18 \u2014 Health monitoring' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        yaml:
          ...
          '      - "robot1/.*"',
        related: [
          { page: 'CON17', hotspot: 'admin-ws', label: 'CON17 \u2014 Admin WebSocket (built-in)' },
          { page: 'CON17', hotspot: 'dashboard-build', label: 'CON17 \u2014 Building a live dashboard' },
          { page: 'CON16', hotspot: 'hot-reconfig', label: 'CON16 \u2014 Add sinks at runtime' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        yaml:
          ...
          '    web_root: ./www',
        related: [
          { page: 'CON17', hotspot: 'self-contained', label: 'CON17 \u2014 Self-contained dashboard setup' },
          { page: 'CON17', hotspot: 'ws-sink', label: 'CON17 \u2014 WebSocket Server sink' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON17', hotspot: 'ws-sink', label: 'CON17 \u2014 WebSocket Server sink config' },
          { page: 'CON17', hotspot: 'self-contained', label: 'CON17 \u2014 Self-contained setup' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON17', hotspot: 'http-sink', label: 'CON17 \u2014 WebServer sink config' },
          { page: 'CON17', hotspot: 'ws-sink', label: 'CON17 \u2014 WebsocketServer sink config' },
