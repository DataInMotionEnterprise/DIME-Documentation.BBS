  ...
  hotspots: [
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON18', hotspot: 'system-msgs', label: 'CON18 \u2014 $SYSTEM message details' },
          { page: 'CON05', hotspot: 'admin-server', label: 'CON05 \u2014 Admin server monitoring' },
          { page: 'CON08', hotspot: 'exclude-filter', label: 'CON08 \u2014 Excluding $SYSTEM messages' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        yaml:
          ...
          '      - "debug/.*"',
        related: [
          { page: 'CON08', hotspot: 'include-filter', label: 'CON08 \u2014 Include filter (whitelist)' },
          { page: 'CON07', hotspot: 'fanout', label: 'CON07 \u2014 Sink fan-out' },
          { page: 'CON20', hotspot: 'connector-rbe', label: 'CON20 \u2014 Report By Exception' },
          { page: 'CON04', hotspot: 'sink-anatomy', label: 'CON04 \u2014 Sink configuration' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        yaml:
          ...
          '      - "mqtt/temperature"',
        related: [
          { page: 'CON08', hotspot: 'exclude-filter', label: 'CON08 \u2014 Exclude filter (blacklist)' },
          { page: 'CON08', hotspot: 'paths', label: 'CON08 \u2014 Message path format' },
          { page: 'CON05', hotspot: 'data-flow', label: 'CON05 \u2014 Data flow architecture' },
          { page: 'CON04', hotspot: 'sink-anatomy', label: 'CON04 \u2014 Sink configuration' }
        ]
      }
    },
