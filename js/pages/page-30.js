...
DIME_PAGES['30'] = {
  id: '30',
  title: '30 \u2014 Troubleshooting',
  file: 'content/30-troubleshooting.md',
  hotspots: [
    {
      id: 'no-data',
      ...
      panel: {
        ...
        related: [
          ...
          { page: '04', hotspot: 'item-anatomy', label: '04 \u2014 Item configuration & type tags' }
        ]
      }
    },
    {
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: '04', hotspot: 'item-anatomy', label: '04 \u2014 Type tags explained' },
          { page: '04', hotspot: 'file-loading', label: '04 \u2014 File loading & merge order' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: '30', hotspot: 'no-data', label: 'No data flowing checklist' },
          { page: '29', hotspot: 'bottlenecks', label: '29 \u2014 Performance diagnostics' }
        ]
      }
    }
  ]
