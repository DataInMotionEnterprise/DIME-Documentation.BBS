...
DIME_PAGES['29'] = {
  ...
  file: 'content/29-performance-tuning.md',
  hotspots: [
    {
      id: 'ring-buffer',
      ...
      panel: {
        ...
        related: [
          ...
          { page: '04', hotspot: 'app-section', label: '04 \u2014 App configuration block' },
          { page: '29', hotspot: 'backpressure', label: 'Backpressure and slow sinks' }
        ]
      }
    },
    {
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: '05', hotspot: 'performance', label: '05 \u2014 Performance by design' },
          { page: '29', hotspot: 'backpressure', label: 'What happens under backpressure' }
        ]
      }
    },
    {
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: '30', label: '30 \u2014 Troubleshooting guide' }
        ]
      }
    }
  ]
