  ...
  hotspots: [
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: 'CON18', hotspot: 'auto-recovery', label: 'CON18 \u2014 Auto-recovery behavior' },
          { page: 'CON20', label: 'CON20 \u2014 Report By Exception (RBE)' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: 'CON18', hotspot: 'alerting', label: 'CON18 \u2014 Monitoring & Alerting' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON29', hotspot: 'bottlenecks', label: 'CON29 \u2014 Finding bottlenecks' },
          { page: 'CON20', label: 'CON20 \u2014 Report By Exception (RBE)' },
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON18', hotspot: 'states', label: 'CON18 \u2014 Connector state machine' },
