  ...
  hotspots: [
    {
      ...
      panel: {
        ...
        body:
          ...
          '</ul>',
        related: [
          { page: 'CON03', hotspot: 'windows', label: 'Windows installation' },
          { page: 'CON03', hotspot: 'linux', label: 'Linux installation' },
          { page: 'CON03', hotspot: 'docker', label: 'Docker deployment' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON03', hotspot: 'verify', label: 'Verify it works' },
          { page: 'CON03', hotspot: 'directories', label: 'Directory layout' }
        ]
      }
    },
    {
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON03', hotspot: 'ports', label: 'Default ports reference' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: 'CON05', hotspot: 'system-diagram', label: 'CON05 \u2014 Full system diagram' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        body:
          ...
          '</ul>',
        related: [
          { page: 'CON01', hotspot: 'yaml-config', label: 'CON01 \u2014 YAML configuration example' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON05', hotspot: 'admin-server', label: 'CON05 \u2014 Admin server endpoints' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        body:
          ...
          '</ul>',
        related: [
          { page: 'CON05', hotspot: 'admin-server', label: 'CON05 \u2014 Admin server details' },
          { page: 'CON03', hotspot: 'docker', label: 'Docker port mapping' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON01', hotspot: 'yaml-config', label: 'CON01 \u2014 YAML config example' },
          { page: 'CON03', hotspot: 'windows', label: 'Windows installation details' },
          { page: 'CON03', hotspot: 'linux', label: 'Linux installation details' }
        ]
      }
    }
  ]
