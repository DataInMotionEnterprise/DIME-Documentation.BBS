...
DIME_PAGES['CON04'] = {
  id: 'CON04',
  title: 'CON04 \u2014 YAML Configuration',
  ...
  hotspots: [
    ...
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON06', label: 'CON06 \u2014 Source connectors reference' },
          { page: 'CON04', hotspot: 'item-anatomy', label: 'Item anatomy details' },
          { page: 'CON05', hotspot: 'source-types', label: 'CON05 \u2014 Source connector base classes' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: 'CON05', hotspot: 'data-flow', label: 'CON05 \u2014 How data reaches sinks' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        yaml:
          ...
          '    enabled: !!bool true',
        related: [
          { page: 'CON04', hotspot: 'source-anatomy', label: 'Source anatomy (parent)' },
          { page: 'CON06', label: 'CON06 \u2014 Source connectors reference' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          ...
          { page: 'CON03', hotspot: 'directories', label: 'CON03 \u2014 Directory layout' }
        ]
      }
    },
    {
      ...
      panel: {
        ...
        related: [
          { page: 'CON01', hotspot: 'yaml-config', label: 'CON01 \u2014 YAML config example' },
          { page: 'CON03', hotspot: 'quick-start', label: 'CON03 \u2014 Quick start guide' },
          { page: 'CON06', label: 'CON06 \u2014 Source connectors reference' },
          { page: 'CON07', label: 'CON07 \u2014 Sink connectors reference' }
        ]
      }
